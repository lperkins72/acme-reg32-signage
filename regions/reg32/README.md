...
This folder is the region-default content layer for `reg32`.
...
- `regions/reg32/data/primary-assets.json`
- `regions/reg32/data/primary.json`
- `regions/reg32/data/footer.json`
- `regions/reg32/data/primaryending.json`
- `regions/reg32/assets/primary/manifest.json`
- `regions/reg32/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg32`.
